---
layout: post
title: Paper Review:"Design Principles for Energy Efficient Legged Locomotion and Implementation on the MIT Cheetah Robot"
date: 2025-12-26 12:00:00
description: Focusing on Actuator Design & Energy Flow Cycle 
tags: Actuator Energy
categories: paper
thumbnail: assets/img/study-paper-review01/figure5.png
...
{% include figure.liquid loading="eager" path="assets/img/study-paper-review01/figure2.png" width="100%" max-width="400px" alt="Energy flow diagram" class="img-fluid rounded z-depth-1" %}
...
<td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review01/figure1.png" width="100%" max-width="400px" alt="Actuator image 1" class="img-fluid rounded z-depth-1" %}</td>
  ...
  <table class="table table-sm table-hover table-bordered">
    <thead class="thead-light">
      <tr>
        ...
        <th style="width: 15%; text-align: center;">Baseline</th>
        <th style="width: 15%; text-align: center;">Improved</th>
        <th style="width: 45%;">Logic</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style="vertical-align: middle;"><b>Torque Density</b></td>
        <td style="text-align: center; vertical-align: middle;">$1$</td>
        <td style="text-align: center; vertical-align: middle;"><b>$2$</b></td>
        <td style="vertical-align: middle;"><b>Doubled</b> (Given condition)</td>
      </tr>
      <tr>
        <td style="vertical-align: middle;"><b>Motor Constant ($K_m$)</b></td>
        <td style="text-align: center; vertical-align: middle;">$K$</td>
        <td style="text-align: center; vertical-align: middle;">$2K$</td>
        <td style="vertical-align: middle;">Torque capacity doubles while mass stays constant</td>
      </tr>
      <tr>
        <td style="vertical-align: middle;"><b>Required Current ($I$)</b><br><small style="color: gray;">(for same torque)</small></td>
        <td style="text-align: center; vertical-align: middle;">$I_{req}$</td>
        <td style="text-align: center; vertical-align: middle;">$\frac{1}{2} I_{req}$</td>
        <td style="vertical-align: middle;">Current <b>is halved</b> due to doubled $K_m$</td>
      </tr>
      <tr>
        <td style="vertical-align: middle;"><b>Joule Heating Loss ($E_j$)</b></td>
        <td style="text-align: center; vertical-align: middle;">$P_{loss}$</td>
        <td style="text-align: center; vertical-align: middle;">$\frac{1}{4} P_{loss}$</td>
        <td style="vertical-align: middle;">Heating scales with current squared<br>$(\frac{1}{2})^2 = \frac{1}{4}$</td>
      </tr>
      <tr style="background-color: #f8f9fa;"> <td style="vertical-align: middle;"><b>Reduction in Heat Loss</b></td>
        <td style="text-align: center; vertical-align: middle;">-</td>
        <td style="text-align: center; vertical-align: middle; color: #dc3545;"><b>75% reduction</b></td>
        <td style="vertical-align: middle;">$100\% - 25\% = \mathbf{75\%}$ <b>saved</b></td>
      </tr>
    </tbody>
  </table>
</div>
...
<td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review01/figure5.png" width="100%" max-width="400px" alt="Figure5" class="img-fluid rounded z-depth-1" %}</td>
