...
1.  **High Simulator Fidelity:** Improving system identification, actuator modeling, and latency simulation.
...
For these reasons, this paper demonstrates exactly what I want to learn. I have re-categorized the factors that impact the sim-to-real gap to help me improve my own simulation environment and build a robust controller.
