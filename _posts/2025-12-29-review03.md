...
{% include figure.liquid loading="eager" path="assets/img/study-paper-review01/figure2.png" width="100%" max-width="400px" alt="Energy flow diagram" %}
...
<td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review01/figure1.png" width="100%" max-width="400px" alt="Actuator image 1" %}</td>
...
<td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review01/figure5.png" width="100%" max-width="400px" alt="Figure5" %}</td>
