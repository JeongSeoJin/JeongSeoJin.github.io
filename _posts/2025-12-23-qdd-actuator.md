...
tags: QDD-Actuator Cycloidal-Reducer
categories: project
...
{% include video.liquid path="https://www.youtube.com/embed/m4KiFf9MHiw" width="100%" height="250px" max-width="300px" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/c-qdd-actuator/rotorcad.png" width="100%" max-width="400px" alt="Actuator image 2" class="img-fluid rounded z-depth-1" %}
