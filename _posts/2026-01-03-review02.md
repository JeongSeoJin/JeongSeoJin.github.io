---
layout: post
title: "Paper Review: \"Demonstrating Berkeley Humanoid Lite: An Open-source, Accessible, and Customizable 3D-printed Humanoid Robot\""
date: 2026-01-03 12:00:00
description: Focusing on Actuator Design & Evaluation Process
tags: QDD-Actuator Cycloidal-Reducer Humanoid
categories: paper
thumbnail: assets/img/study-paper-review02/fig1.png
...
This paper demonstrates accessible 3d-printed low-cost humanoid robot promoting democratization in humanoid robotics. The core design is a **modular 3d-printed** actuator easily replaceable, preventing delays of an experiment from broken parts of robots. Also The authors conduct experiments to validate **reliability** of 3d-printed actuator. Futhermore, the experiments showcased **zero-shot policy transfer** from simulation to hardware, highlighting the platform's suitability for research validation.
  ...
  <table>
    <tr>
      <td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/fig1.png" width="100%" max-width="250px" alt="Actuator image 1" class="img-fluid rounded z-depth-1" %}</td>
...
<table>
  ...
  <tr>
    <td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/BOM.png" width="100%" max-width="250px" alt="Actuator image 1" class="img-fluid rounded z-depth-1" %}</td>
    <td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/controller.png" width="100%" max-width="300px" alt="Actuator image 2" class="img-fluid rounded z-depth-1" %}</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/encoder.png" width="100%" max-width="250px" alt="Actuator image 1" class="img-fluid rounded z-depth-1" %}</td>
    <td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/motor.png" width="100%" max-width="300px" alt="Actuator image 2" class="img-fluid rounded z-depth-1" %}</td>
  </tr>
</table>

<caption>Specification of 'M6C12 150kv BLDC Drone Motor'</caption>
<td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/specification.png" width="100%" max-width="600px" alt="Actuator image 2" class="img-fluid rounded z-depth-1" %}</td>
...
configurations.
<td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/fig7.png" width="100%" max-width="600px" alt="Actuator image 2" class="img-fluid rounded z-depth-1" %}</td>
...
<td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/fig8.png" width="100%" max-width="600px" alt="Actuator image 2" class="img-fluid rounded z-depth-1" %}</td>
...
<td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/fig9.png" width="100%" max-width="600px" alt="Actuator image 2" class="img-fluid rounded z-depth-1" %}</td>
...
<td>{% include figure.liquid loading="eager" path="assets/img/study-paper-review02/fig10.png" width="100%" max-width="600px" alt="Actuator image 2" class="img-fluid rounded z-depth-1" %}</td>
...
---
## Reference
**Citation**: [https://doi.org/10.48550/arXiv.2504.17249](https://doi.org/10.48550/arXiv.2504.17249)
